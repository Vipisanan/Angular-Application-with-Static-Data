...
!function (t, e) {
    ...
    placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
      ...
      shift: {
        ...
        order: 850, enabled: !0, fn: function (t, e) {
          ...
          var s = void 0 !== r ? r : e.gpuAcceleration, a = R(t.instance.popper), l = G(a), c = {position: o.position},
            u = function (t, e) {
              var n = t.offsets, i = n.popper, o = n.reference, r = Math.round, s = Math.floor, a = function (t) {
                ...
                h = -1 !== t.placement.indexOf("-"), f = e ? u || h || l % 2 == c % 2 ? r : s : a, d = e ? r : a;
              return {
  ...
  var It = "dropdown", xt = e.fn[It], jt = new RegExp("38|40|27"),
    ...
    he = {offset: "number", method: "string", target: "(string|element)"}, fe = function () {
      ...
      return n.refresh = function () {
        var t = this, n = this._scrollElement === this._scrollElement.window ? "offset" : "position",
          i = "auto" === this._config.method ? n : this._config.method, o = "position" === i ? this._getScrollTop() : 0;
